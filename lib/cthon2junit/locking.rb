    ...
    class Locking
        ...
        def parse
            begin
                ...
                errmsg = "Connectathon Locking test output file was not found!!"
                @testsuite.stdout = errmsg
                test = Cthon::Test.new("Locking test failure")
                test.success = false
                test.msg = errmsg
                @testsuite << test
                return
        ...
        def parsestr(lines)
            ...
            lines.each do |line|
                ...
                if line =~ /Congratulations, you passed the locking tests!/
                    @success = true
                end
            end

            @test = Cthon::Test.new("Locking Tests")
